...
const struct rcc_clock_scale rcc_clock_config[RCC_CLOCK_CONFIG_END] = {
	...
	[RCC_CLOCK_CONFIG_HSI_PLL_32MHZ] = {
		...
		.pll_div = RCC_PLLCFGR_PLLM_NODIV,
		.pll_mul = RCC_PLLCFGR_PLLN_MUL(8),
		.pllp_div = RCC_PLLCFGR_PLLP_DIV4,
		.pllq_div = RCC_PLLCFGR_PLLQ_DIV4,
		.pllr_div = RCC_PLLCFGR_PLLR_DIV4,
		.hpre = RCC_CFGR_HPRE_NODIV,
		.ppre = RCC_CFGR_PPRE_NODIV,
	...
	[RCC_CLOCK_CONFIG_HSI_PLL_64MHZ] = {
		...
		.pll_div = RCC_PLLCFGR_PLLM_NODIV,
		.pll_mul = RCC_PLLCFGR_PLLN_MUL(8),
		.pllp_div = RCC_PLLCFGR_PLLP_DIV2,
...
/**
 * Set up sysclock with desired source (HSE/HSI/PLL/LSE/LSI). taking care of flash/pwr and src configuration
